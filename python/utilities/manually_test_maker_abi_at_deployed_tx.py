...
batInstance = web3.eth.contract(abi=makerAbi, address=web3.toChecksumAddress("0x0d8775f648430679a709e98d2b0cb6250d2887ef"))
functionData = fetchPureViewFunctionData(batInstance)
